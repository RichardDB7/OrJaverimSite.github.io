            ...
            <div class="container">
                ...
                <div class="main-menu collapse navbar-collapse" id="portfolio-perfect-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="page-scroll"><a href="../http://127.0.0.1:5500/">Home</a></li>
           ...
           <p class="section-subtitle"> <?= $message ?></p>
            ...
            <div class="row">
                <form id="formlogin" action="FormLogin.php" method="POST">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" name="email" type="text" placeholder="&#129333; Escriba su Usuario"id="usuario" placeholder="Nombre" required>
                    </div>
                    <div class="col-sm-12">
                        <input class="form-control" name="password" placeholder="&#128272; Escriba su Clave" id="pass" required>
                    </div>
